...
<body>
    ...
    <form method="post" action="guardar_cotizacion_playera.php">
        <h2>Cotizador de Playeras</h2>
        <P>Playera CH:$30 <br> Playera M:$40 <br> Playera G:$50</P>
        <p>Promociones:</p>
        <p>Por cada 10 productos, obtiene un 20% de descuento.</p>
        <p>Por cada color, son $20 adicionales.</p>
        <label for="tallas">Seleccione Tallas:</label>
    ...
    <script>
        ...
        const cantidadChInput = document.getElementById('cantidad_ch_input');
        const cantidadMInput = document.getElementById('cantidad_m_input');
        const cantidadGInput = document.getElementById('cantidad_g_input');
        tallasSelect.addEventListener('change', function() {
            cantidadChInput.style.display = 'none';
            cantidadMInput.style.display = 'none';
            cantidadGInput.style.display = 'none';
            const selectedTalla = tallasSelect.value;
            if (selectedTalla === 'CH') {
                cantidadChInput.style.display = 'block';
            } else if (selectedTalla === 'M') {
                cantidadMInput.style.display = 'block';
            } else if (selectedTalla === 'G') {
                cantidadGInput.style.display = 'block';
            }
        });
    </script>
